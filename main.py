"""
Traffic Flow Prediction with Neural Networks GRU
"""
import math
import warnings
import numpy as np
...
def plot_results(y_true, y_preds, names):
    ...
    """
    d = '2018-07-01 00:00:00'
    x = pd.date_range(d, periods=120, freq='15min')
...
def main():
    ...
    _, _, X_test, y_test, scaler = process_data(raw_data, lag)
